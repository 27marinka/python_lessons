...
"""
Тут какое-то корячество
"""
text = text.replace((crypto_keys[0][1]), (crypto_keys[0][0]))
text = text.replace((crypto_keys[1][1]), (crypto_keys[1][0]))
text = text.replace((crypto_keys[2][1]), (crypto_keys[2][0]))
text = text.replace((crypto_keys[3][1]), (crypto_keys[3][0]))
text = text.replace((crypto_keys[4][1]), (crypto_keys[4][0]))
text = text.replace((crypto_keys[5][1]), (crypto_keys[5][0]))
text = text.replace((crypto_keys[6][1]), (crypto_keys[6][0]))

print(text)


"""
Тут очевидное быстрое решение

for keys_pair in crypto_keys:
    text = text.replace((keys_pair[1]), (keys_pair[0]))
